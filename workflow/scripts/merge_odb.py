    ...
    try:
        ...
        for chunk in members:
            ...
            with db:
                ...
                db.execute("INSERT OR IGNORE INTO mappings SELECT query, og FROM chunk_mappings")
        ...
        write_json(qc, {"created_at": now(), "chunks": len(members), "input_annotation_rows": input_rows,
                        "unique_gene_og_pairs": count, "duplicate_pairs_removed": input_rows - count,
